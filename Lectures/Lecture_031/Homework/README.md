...
**Q1:** Print sum of each column in 2D array. [Here](./1.cpp)

**Q2:** Given 2 matrices A and B, Print A-B. [Here](./Lecture_Code/Add_Subtract.cpp)
...
So the final answer will be 25. [Here](./3.cpp)
...
**Q5:** Largest Element: Find and print the largest element in the 2D array. [Here](./5.cpp)

**Q6:** Smallest Element: Find and print the smallest element in the 2D array. [Here](./6.cpp)
