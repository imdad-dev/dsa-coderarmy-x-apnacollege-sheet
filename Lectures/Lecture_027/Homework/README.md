...
**Q2:** How to find the number of Occurance of an element in a vector. You need to use STL here. [Here](./2.cpp)


**Q3:** How to find maximum and minimum elements from the vector. USE STL here. [Here](./3.cpp)

**Q4:** Find Lower bound and Upper Bound of a given element in a sorted vector. USE STL here to find them. [Here](./4.cpp)

**Q5:** How to pass a vector to a function. Write a small code for it. [Here](./5.cpp)